...
unsigned int countNotIncludedChars(const std::string &search_in, const std::string &search_for) {
...
int main() {
    ...
    std::map<std::size_t , std::vector<int>> size_to_number = {{2,{1}}, {3,{7}}, {4, {4}},{5, {2, 3, 5}}, {6,{0,6,9}},
                                                               {7, {8}}};
...
position_cost_item calc_cheapest_position(const std::vector<unsigned int> &positions) {
    ...
    auto last_position = count_crabs_on_same_position.rbegin()->first; //greatest position
