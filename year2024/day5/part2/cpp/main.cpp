...
bool CheckCurrentPair(const rules_t &rules, const pages_t &pages,
                      std::size_t pos) {
...
std::pair<bool, std::size_t> ArePagesCorrect(const rules_t &rules,
                                             const pages_t &pages) {
...
bool DoCorrection(const rules_t &rules, pages_t &pages,
